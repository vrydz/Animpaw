...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    "nav.guide": "PANDUAN",
    "nav.shop": "SHOP 🛒",
    "shop.title": "PUSAT DUKUNGAN NEKOMON",
    "shop.desc": "Kelola energi kartu dan klaim hadiah aktivitas menggunakan sumber daya dalam game.",
    ...
    "mail.dev_gift_btn": "⚡ HADIAH DEVELOPER",
    "mail.dev_gift_title": "Panel Hadiah Developer (Poin & Cores)",
    "mail.dev_gift_desc": "Kirim Poin Trainer dan Nekomon Cores secara privat ke trainer tertentu atau disiarkan ke seluruh pemain.",
    "mail.dev_gift_tab_private": "👤 Hadiah Privat (1 Trainer)",
    "mail.dev_gift_tab_broadcast": "📢 Hadiah Broadcast (Semua Trainer)",
    "mail.dev_target_user": "Pilih Trainer Tujuan *",
    "mail.dev_target_placeholder": "Ketik username trainer...",
    "mail.dev_points_grant": "Jumlah Poin Trainer (+Pts)",
    "mail.dev_cores_grant": "Jumlah Nekomon Cores (+Cores)",
    "mail.dev_note_label": "Catatan / Alasan Hadiah (Opsional)",
    "mail.dev_note_placeholder": "e.g. Hadiah apresiasi, bonus event, atau kompensasi...",
    "mail.dev_send_gift_btn": "KIRIM HADIAH SEKARANG 🎁",
    "mail.dev_sending": "MENGIRIM HADIAH...",
    "mail.dev_dist_mode": "Metode Distribusi Hadiah Broadcast",
    "mail.dev_dist_instant": "⚡ Kredit Instan Langsung ke Semua Akun",
    "mail.dev_dist_claimable": "📬 Surat Resmi dengan Tombol Klaim di Inbox",
    "mail.quick_gift_dm": "🎁 Beri Gift",
    // Territory Cooldown Keys
    "territory.cooldown_badge": "JEDA PENAKLUKAN (2 JAM)",
    "territory.cooldown_active": "Jeda Penaklukan Teritori Aktif",
    "territory.cooldown_desc": "Setelah merebut sebuah Beacon, penyerangan ke node di sekitarnya dijeda selama 2 jam demi menyeimbangkan permainan & mencegah ekspansi kilat.",
    "territory.cooldown_timer_prefix": "Sisa Waktu Jeda:",
    "territory.cooldown_locked_attack": "TERKUNCI: JEDA PENAKLUKAN",
    "territory.cooldown_node_fortified": "Node Sedang Dalam Masa Pemulihan & Stabilisasi Energi Pasca-Penaklukan (2 Jam).",
    "territory.cooldown_adjacent_locked_notice": "Serangan ke area ini terkunci sementara karena kamu baru saja merebut node yang terhubung.",
  },
  en: {
    // Nav & Common
    "nav.camera": "CAMERA",
    ...
    "nav.shop": "SHOP 🛒",
    "nav.mail": "MAILBOX",
    "shop.title": "NEKOMON SUPPORT CENTER",
    "shop.desc": "Manage card energy and claim activity rewards using in-game resources.",
    ...
    "mail.dev_gift_btn": "⚡ DEV GIFT CENTER",
    "mail.dev_gift_title": "Developer Gift Panel (Points & Cores)",
    "mail.dev_gift_desc": "Grant Trainer Points and Nekomon Cores privately to specific trainers or broadcast to all players.",
    "mail.dev_gift_tab_private": "👤 Private Gift (Single Trainer)",
    "mail.dev_gift_tab_broadcast": "📢 Broadcast Gift (All Trainers)",
    "mail.dev_target_user": "Select Target Trainer *",
    "mail.dev_target_placeholder": "Search or type trainer username...",
    "mail.dev_points_grant": "Trainer Points Amount (+Pts)",
    "mail.dev_cores_grant": "Nekomon Cores Amount (+Cores)",
    "mail.dev_note_label": "Note / Gift Reason (Optional)",
    "mail.dev_note_placeholder": "e.g. Bug bounty reward, event bonus, or tester appreciation...",
    "mail.dev_send_gift_btn": "SEND GIFT NOW 🎁",
    "mail.dev_sending": "SENDING GIFT...",
    "mail.dev_dist_mode": "Broadcast Distribution Mode",
    "mail.dev_dist_instant": "⚡ Instant Direct Credit to All Accounts",
    "mail.dev_dist_claimable": "📬 Official Mail with Claim Button in Inbox",
    "mail.quick_gift_dm": "🎁 Send Gift",
    // Territory Cooldown Keys
    "territory.cooldown_badge": "CAPTURE COOLDOWN (2 HOURS)",
    "territory.cooldown_active": "Territory Capture Cooldown Active",
    "territory.cooldown_desc": "After capturing a Beacon, attacks on adjacent nodes are paused for 2 hours to balance the game and prevent rapid expansion.",
    "territory.cooldown_timer_prefix": "Remaining Cooldown:",
    "territory.cooldown_locked_attack": "LOCKED: CAPTURE COOLDOWN",
    "territory.cooldown_node_fortified": "Node is currently in post-capture stabilization & fortification cooldown (2 Hours).",
    "territory.cooldown_adjacent_locked_notice": "Attacks on this sector are temporarily locked because you recently captured an adjacent node.",
  }
};
